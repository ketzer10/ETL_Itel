...
def sheet_downloader_and_uploader(expected_columns: list, folder_key: str):
    ...
    for file_id in file_ids:
        ...
        try:
            ...
            # Upload to database
            dbutils.perform_safe_delete_insert_with_keys(conn, ['thirty_minute_interval_start', 'agent_id'], df, schema, table_name)
...
def main(optional: list):
    ...
    expected_columns = ["date","thirty_minute_interval_start","agent_name","agent_id","team_name",
                        "handle_sec", "inbound_hold_sec", "outbound_hold_sec", "outbound_unavailable_sec", 
                        "acw_sec", "inbound_active_talk_sec", "outbound_active_talk_sec", "unavailable_sec", 
                        "available_sec", "hold_sec", "inbound_acw_sec", "inbound_handle_sec", "login_sec", 
                        "outbound_acw_sec", "outbound_handle_sec", "outbound_sec", "refused_sec", "inbound_sec", 
                        "talk_sec"]     
    folder_key = "walmart_call_time_data"
