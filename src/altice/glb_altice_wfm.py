...
from src.altice.config.config_files import configs

# Getting Configs
FOLDER_KEY = "glb_altice_wfm"
...
def main(optional: list):
    ...
    for id in file_ids:
        ...
        try:  
            ...
            df = pd.read_excel(io_data["contents"], skiprows=65, sheet_name=None, dtype = configs[FOLDER_KEY]["read_with_dtype"])
