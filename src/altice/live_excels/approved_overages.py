""" 
Downloads an Excel file containing approved overages from the SharePoint and uploads to the database.  
"""
...
def main(optional: list):
    ...
    sheet_name = 'approved_overages'
    table_name = 'glb_approved_overages'
    expected_columns = ['half_hour_interval', 'line_business', 'approved_overage']
    schema = 'altice'
    file_id = utils.get_config('dshub_sharepoint_config')['files']['altice_glb_approved_overages']['id']
