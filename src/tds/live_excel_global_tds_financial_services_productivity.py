...
CMD comand -> python .\run.py -i 46 -o 1
...
def main(optional: list):
    ...
    match optional[0]:
        case 1:
            FOLDER_KEY = "global_tds_financial_services_productivity"
            ...
            sheet_name = "TDS FinancialS Weekly Metrics"
            schema = "tds"
            table_name = "glb_financial_services_productivity"
            expected_columns = [
                "agent_id",
                "agent_name",
                "week_start",
            ...
            file_id = utils.get_config("dshub_sharepoint_config")["files"]["global_tds_financial_services_productivity"]["id"]
