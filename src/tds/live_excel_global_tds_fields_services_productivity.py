...
def main(optional: list):
    ...
    match optional[0]:
        case 1:
            FOLDER_KEY = "global_tds_fields_services_productivity"
            ...
            sheet_name = "TDS FieldS Daily Metrics"
            schema = "tds"
            table_name = "glb_fields_services_productivity"
            expected_columns = [
                "agent_id",
                "agent_name",
                "date",
            ...
            file_id = utils.get_config("dshub_sharepoint_config")["files"]["global_tds_fields_services_productivity"]["id"]
