...
# Getting Configs
FOLDER_KEY = "tds_detailed_time_record"
...
DELETE_KEYS = ["employee_id","activity","start","end_"]
...
def main(optional: list):
    ...
    for id in file_ids:
        ...
        try:  
            ...
            df = pd.read_excel(io_data["contents"], sheet_name = "Unmanaged report", skiprows=6)
